...
export type Mutation = {
  ...
  TodoInsertOne?: Maybe<Todo>;
  TodoUpdateOne: Todo;
  TodoDeleteOne?: Maybe<Scalars['Boolean']>;
...
export type MutationTodoInsertOneArgs = {
  document: TodoInsertInput;
};


export type MutationTodoUpdateOneArgs = {
  _id: Scalars['ObjectId'];
  document: TodoUpdateInput;
};


export type MutationTodoDeleteOneArgs = {
  _id: Scalars['ObjectId'];
};
...
export type Query = {
  __typename?: 'Query';
  TodoFindOne?: Maybe<Todo>;
  TodoFindOneByID?: Maybe<Todo>;
  TodoFind: Array<Maybe<Todo>>;
...
export type QueryTodoFindOneArgs = {
  query?: Maybe<QueryInput>;
};


export type QueryTodoFindOneByIDArgs = {
  _id: Scalars['ObjectId'];
};


export type QueryTodoFindArgs = {
  query?: Maybe<QueryInput>;
};
...
export type Subscription = {
  ...
  TodoSubscription?: Maybe<SubscriptionEvent>;
  TodoSubscriptionCount?: Maybe<SubscriptionCountEvent>;
  UsersSubscription?: Maybe<SubscriptionEvent>;
  UsersSubscriptionCount?: Maybe<SubscriptionCountEvent>;
};


export type SubscriptionTodoSubscriptionArgs = {
  body?: Maybe<Scalars['EJSON']>;
};


export type SubscriptionTodoSubscriptionCountArgs = {
  filters?: Maybe<Scalars['EJSON']>;
};
