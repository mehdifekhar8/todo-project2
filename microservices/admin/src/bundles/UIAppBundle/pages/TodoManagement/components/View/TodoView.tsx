...
export function TodoView(props: { id: string }) {
  ...
  if (isLoading) {
    ...
    if (error || document === null) {
      ...
      content = <TodoViewComponent document={document} />;
    }
  }
  ...
  return (
    <UIComponents.AdminLayout>
      <Ant.PageHeader
        title={t("management.todo.view.header")}
...
export function TodoViewComponent(props: { document: Partial<Todo> }) {
...
export function getHeaderActions(
  ...
  if (features.edit) {
    actions.push(
      <Link
        key="edit"
        to={router.path(Routes.TODO_EDIT, {
          params: { id },
        })}
      >
  ...
  const viewRoutePath = router.path(Routes.TODO_VIEW, {
    params: { id },
  });
